...
var DioVLOGPlayer = MediaPlayer.extend({
    ...
    ****************************************/
    ...
    playStateChange : function(newState) {
    	var state = DioVLOGPlayer.prototype.getState.call(DioVLOGPlayerObj);
    	console.log("checkState : " + state + " new " + newState);
//    	if(DioVLOGPlayerObj.state == state) {
//    		return;
//    	}
        ...
        case "buffering":
			if(this.recoding) {
    			DioVLOGPlayer.prototype.dioPlay.call(DioVLOGPlayerObj, DioVLOGPlayerObj.player);
    		}
			break;
        case "mediaEnded":
        	console.log("end" + DioVLOGPlayerObj.player.controls.currentPosition);
        	if(this.recoding && DioVLOGPlayerObj.duration == -1) {
        		DioVLOGPlayerObj.duration = this.player.controls.currentItem.duration;
             	DioVLOGPlayerObj.dragEndTime = DioVLOGPlayerObj.duration - 0;
...
//            	$("#cnResult_"+indexI).removeClass("current");
            	if(resultTime1 == 1 ){
